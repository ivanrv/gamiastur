	...
	public String ejecutar(HttpServletRequest request, HttpServletResponse response) {
		...
		case "actividad":
			...
			try {
				...
				if(request.getPart("archivo") != null)
					actividad.getImagenactividads().iterator().next().setArchivo("/actividades/" + request.getAttribute("fileName").toString());
		...
		case "noticia":
			...
			try {
				...
				if(request.getPart("archivo") != null)
					noticia.setImagen("/noticias/" + request.getAttribute("fileName").toString());
		...
		case "deportiva":
			try {
				...
				if(request.getPart("archivo") != null)
					deportiva.setExplicacion("/deportivas/" + request.getAttribute("fileName"));
